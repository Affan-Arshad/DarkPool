    ...
    return (
        <>
            <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">{investment.type}</td>
                <td className="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">
                    {investment.project
                        ? <Link to={`/projects/${investment.project.id}`}>
